<template>
  <div class="flex flex-row sticky top-0 z-60 bg-surface-0">
    <!-- Header Placeholder -->
    <div
      class="left-0 w-80 flex shrink-0 sticky z-60 justify-center items-center box-border border-r border-b border-surface-200 bg-surface-50 text-surface-900 font-semibold"
    >
      {{ t(headerLabel) }}
    </div>
    <!-- Headers -->
