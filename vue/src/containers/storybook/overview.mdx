...
routes: [
    {
      ...
      children: [
        ...
        {
          ...
          children: [
            { path: 'readonly', meta: { wefa: { title: 'Read-Only' }}, ...},
            { path: 'readwrite', meta: { wefa: { title: 'Read + Write' }}, ...},
            { path: 'admin', meta: { wefa: { title: 'Admin' }}, ...}
          ]
        },
        ...
      ]
...
Navigation elements (e.g in the NavbarContainer or SideMenuContainer) rely on metadata specified on `route.meta.wefa`, such as:
